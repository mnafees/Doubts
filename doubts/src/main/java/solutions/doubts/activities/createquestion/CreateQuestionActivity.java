...
public class CreateQuestionActivity extends AppCompatActivity {
    ...
    private void updateTags(String tag) {
        if (tag.endsWith(" ") && tag.length() > 1) {
            // new tag added
            final View v = View.inflate(CreateQuestionActivity.this,
            ...
            if (mTagsList.contains(newTag)) {
                ...
                mTags.getText().clear();
                Toast.makeText(CreateQuestionActivity.this, "Tag already added", Toast.LENGTH_SHORT)
                        .show();
                return;
            } else {
                // add new tag
                ...
                .create(q, new ProgressCallback() {
                    ...
                    public void onCompleted(Exception e, Response<JsonObject> result) {
                        if (e != null) {
                            ...
                            Snackbar.make(mCameraFragment.getView(), getString(R.string.network_error_message), Snackbar.LENGTH_SHORT)
                                    .show();
                        } else {
    ...
    private void confirmAndExit() {
        AlertDialog dialog = new AlertDialog.Builder(this, R.style.Base_Theme_AppCompat_Light_Dialog_Alert)
                ...
                .setMessage("Are you sure you want to discard this question?")
